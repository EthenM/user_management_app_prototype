        ...
        <main className="flex bg-gray-100 h-screen">
            <section className="flex flex-col min-w-60">
                <nav>
                    <header className="border-b p-4">
                        <a className="flex gap-3 cursor-pointer" href="/home">
                            ...
                            <p className="font-medium">TaekwondoOn</p>
                        </a>
                    </header>
                    ...
                    <ul>
                        {/* HOME */}
                        <PageLink pageName="home" pagePath="/home">
                            <svg
                        ...
                        {/* STUDENTS */}
                        <PageLink pageName="students" pagePath="/students">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                        ...
                        {/* INSTRUCTORS */}
                        <PageLink pageName="instructors" pagePath="/instructors">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                        ...
                        {/* SCHEDULES */}
                        <PageLink pageName="schedules" pagePath="/schedules">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                        ...
                        {/* EVENTS */}
                        <PageLink pageName="events" pagePath="/events">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                        ...
                        {/* SETTINGS */}
                        <PageLink pageName="settings" pagePath="/settings">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                ...
                <section className="mt-5 flex-grow pl-5">
                    <h3 className="text-gray-400 text-xs font-medium">Upcoming Events</h3>

                    <ul className="mt-3">
                        {
                            upcommingEvents.map(event => 
                                <li key={event.id} className="text-sm font-medium mt-3">
                                    {event.title}
                                </li>
                            )
                        }
